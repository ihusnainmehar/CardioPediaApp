...
public class DoctorMoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DprofileTxtView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                Intent k = new Intent(DoctorMoreActivity.this, DocProfileActivity.class);
                startActivity(k);
            }
        });
        ...
        SettingsTxtView.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent k = new Intent(DoctorMoreActivity.this, SettingsActivity.class);
                startActivity(k);
            }
        });
        ...
        ComplainTextView.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent k = new Intent(DoctorMoreActivity.this, SubmitComplainActivity.class);
                startActivity(k);
            }
        });
