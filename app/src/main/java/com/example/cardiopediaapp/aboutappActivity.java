...
public class aboutappActivity extends AppCompatActivity {
    ...
    private void addDataToList() {
        ...
        childItems1.add(new ChildItem("Husnain", R.drawable.husnain));
        childItems1.add(new ChildItem("Furqan", R.drawable.furqan));
        childItems1.add(new ChildItem("Ibtisam", R.drawable.ibtisam));
        parentList.add(new ParentItem("Prof. Dr. Ali Raza", R.drawable.sir, childItems1));
    }
}
